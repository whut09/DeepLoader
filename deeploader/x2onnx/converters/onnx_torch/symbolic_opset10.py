...
from .symbolic_helper import parse_args, _unimplemented
...
def sort(g, self, dim, decending, out=None):
    ...
    slice_ = sym_help._slice_helper(g, shape_, axes=axis, starts=start, ends=end, steps=None,
                                    dynamic_slice=True)
...
def topk(g, self, k, dim, largest, sorted, out=None):
    ...
    from .symbolic_opset9 import unsqueeze
    k = unsqueeze(g, k, 0)
...
def _max_pool(name, tuple_fn, ndims, return_indices):
    ...
    def symbolic_fn(g, input, kernel_size, stride, padding, dilation, ceil_mode):
        ...
        if return_indices:
            ...
            from .symbolic_opset9 import sub
